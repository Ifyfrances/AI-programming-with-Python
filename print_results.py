...
def print_results(results_dic, results_stats_dic, model, 
    ...
    for key in results_stats_dic:
        # print out all the percentages in the results_stats_dic
        # write a conditional statement to determine if key starts with letter 'p'
   ...
   # classified as dogs or vice versa - print out these cases  
    ...
    for key in results_dic:
          ...
          # ONLY when the classifier function (classifier label) misclassified dogs specifically:
          # Pet Image Label is a Dog - Classified as NOT-A-DOG -OR- 
          # Pet Image Label is NOT-a-Dog - Classified as a-DOG
        if sum(results_dic[key][3:]) == 1:
             print("Real pet Label: {}   Classifier: {}".format(results_dic[key][0], results_dic[key][1]))
    ...
    for key in results_dic:
              ...
              if ( sum(results_dic[key][3:]) == 2 and
                results_dic[key][2] == 0 ):
                print("Real Pet Label: {}   Classifier: {}".format(results_dic[key][0],
                                                          results_dic[key][1]))